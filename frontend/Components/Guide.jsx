...
const Guide = () => {
   return (
    <div className='py-5'>
        <h3 className='text-center font-bold text-32 leading-32 py-5 mb-4'>Hướng dẫn sử dụng</h3>
          <div className='content'>
            <ul className='list-none'>
                {GuideList.map((item,index)=><li key={index} className='text-20 leading-20 p-3 gap-5'>
